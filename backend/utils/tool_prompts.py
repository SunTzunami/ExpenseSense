...
5. For both broad/major categories (e.g. "Food") and specific sub-categories (e.g. "grocery"), use category=.
...
TOOL_PROMPTS = {
    "plot_time_series": {
        "function_definition": "plot_time_series(df, category=None, year=None, month=None, start_year=None, start_month=None, end_year=None, end_month=None, months=None)",
...
plot_time_series(df, category='Food', start_year=2023, end_year=2025)
...
plot_time_series(df, category='Transportation')
...
plot_time_series(df, category='combini meal', months=12)"""
    ...
    "plot_distribution": {
        "function_definition": "plot_distribution(df, category=None, remarks=None, year=None, month=None, start_year=None, start_month=None, end_year=None, end_month=None, months=None, ignore_rent=False)",
        "examples": """Q: "Show me a breakdown of my food expenses in 2024"
plot_distribution(df, category='Food', year=2024)
...
plot_distribution(df, category='Transportation', start_year=2022, end_year=2024)
...
plot_distribution(df, category='Fitness', year=2025)"""
    },

    "plot_comparison_bars": {
        "function_definition": "plot_comparison_bars(df, category=None, y1=None, m1=None, d1=None, y2=None, m2=None, d2=None)",
        "examples": """Q: "Compare food spending in 2024 vs 2025"
plot_comparison_bars(df, category='Food', y1=2024, y2=2025)
...
plot_comparison_bars(df, category='Transportation', y1=2024, m1=7, d1=21, y2=2025, m2=7, d2=21)
...
plot_comparison_bars(df, category='gym', y1=2024, m1=11, y2=2025, m2=11)"""
    ...
    "calculate_total": {
        "function_definition": "calculate_total(df, category=None, remarks=None, year=None, month=None, day=None, start_year=None, start_month=None, end_year=None, end_month=None, months=None)",
...
calculate_total(df, category='Food', months=1)
...
calculate_total(df, category='Transportation', year=2025)
...
calculate_total(df, category='combini meal', year=2025)"""
    ...
    "get_top_expenses": {
        "function_definition": "get_top_expenses(df, n=10, category=None, year=None, month=None, day=None, start_year=None, start_month=None, end_year=None, end_month=None, months=None, min_amount=None, ignore_rent=False)",
...
get_top_expenses(df, n=10, category='Food', year=2025, month=6)
