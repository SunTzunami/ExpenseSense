...
from llama_cpp.llama_chat_format import Jinja2ChatFormatter, ChatFormatterResponse, chat_formatter_to_chat_completion_handler
...
response = llm.create_chat_completion([{'role': 'user', 'content': 'What is 2+2?'}], max_tokens=20)
print("OUTPUT:")
